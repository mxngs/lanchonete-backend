...
const getBuscarProdutoNome = async function (nome) {
    ...
    try {
        ...
        let produtoJSON = {};
        //tratamento do ID para verificar se o ID é válido(vazio, indefinido ou não numerico)
        if (nomeProduto == '' || nomeProduto == undefined || nomeProduto == null) {
            return message.ERROR_INVALID_ID //400
        } else {


            // encaminha o id para o DAO buscar no banco de dados 
            let dadosProduto = await produtoDAO.selectProdutobyNome(nomeProduto)
